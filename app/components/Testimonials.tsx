...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    bgColor: "#FECA8E",
    companyLogo: "/images/testimonials/techsolutions.svg",
    quote: "Créativité et professionnalisme",
    testimonial: [
      "Travailler avec Titouan a été une expérience enrichissante. Sa capacité à comprendre les besoins techniques et à les traduire en interfaces utilisateur intuitives est remarquable.",
      "Il sait allier créativité et rigueur pour livrer des projets de qualité dans les délais.",
    ],
  },
  {
    id: 3,
    name: "Ambre Lardry",
    role: "UI / UX Designer",
    image: "/images/Ambre.png",
    bgColor: "#8EFECA",
    companyLogo: "/images/testimonials/designlab.svg",
    quote: "Un collaborateur hors pair",
    testimonial: [
      "Titouan possède une vision unique du design et une attention particulière aux détails qui font toute la différence. Son approche collaborative et sa bienveillance créent un environnement de travail très agréable.",
      "Je recommande vivement de travailler avec lui sur tout projet créatif.",
    ],
  },
];
